<template><!--大板车认证-->
    <div class="case">
                        ...
                        <div class="car-tabs">
                            <el-tabs type="border-card" @tab-click="tabClick">
                                <el-tab-pane label="牵引车 中置轴前车">
                                    ...
                                    <div class="car-way-nothing" v-if="showTable1 === 0">
                                    ...
                                    <!--有数据显示的时候-->
                                    <div class="car-way-table" v-if="showTable1 === 1" :key="Math.random()">
                                        <el-table
                                            ...
                                            <el-table-column
                                                ...
                                                <template slot-scope="scope">
                                                    <span @click="openCarTrailerInfoMobel(scope.row,'1','车辆详情')"
                                                          class="car-way-blue">{{scope.row.dlPlateNo}}挂</span>
        ...
        <!--批量导入弹窗-->
        <el-dialog class="capacity-pop capacity-line capacity-pop-big" title="牵引车 中置轴前车批量导入" :visible.sync="bulkImport" width="40%"
                   center>
                ...
                <el-form :model="bulkImportRulesForm" :rules="bulkImportRules" ref="bulkImportRulesForm"
                    ...
                    <el-form-item label="模板下载">
                        <!--<el-upload
                                ...
                                :file-list="fileList">
                            <el-button size="small" type="primary"><i class="import-icon el-icon-download"></i>下载批量导入模板
                            </el-button>
