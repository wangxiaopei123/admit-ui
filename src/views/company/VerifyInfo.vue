					...
					<el-col :span="24" class="info-case">
						<el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="150px" class="demo-ruleForm">
							...
							<el-form-item label="注册资本：" prop="regCapital" onkeyup="value=value.replace(/[\u4E00-\u9FA5]/g,'')">
								<el-input v-model="ruleForm.regCapital" maxlength="100"></el-input>
							</el-form-item>
							...
							<el-form-item label="通信地址" class="address">
								...
								<el-select v-model="ruleForm.agentAreaId" placeholder="请选择区" @change="setMapArea(ruleForm.agentProvId,ruleForm.agentCityId,ruleForm.agentAreaId)">
								...
								<el-input v-model="ruleForm.agentAddress" class="width-other"  >
									<template slot="append"><span @click="openMap('agentAddress')"><i class="el-icon-location-outline"></i></span></template>
								</el-input>
							</el-form-item>
							</div>
							<el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
			...
			,setMapArea(agentProvId,agentCityId,agentAreaId) {
                let agentProvName = this.common.getProvinceName(this,agentProvId,this.provinceOption);
                let agentCityName = this.common.getCityName(this,agentCityId,this.cityOption);
                let agentAreaName = this.common.getAreaName(this,agentAreaId,this.areaOption);

                // console.log("dadsihdhskds",agentProvName+agentCityName+agentAreaName)
                // this.center = agentProvName+agentCityName+agentAreaName;
			}
			,setMap() {
                ...
                //         this.position = {lng: r.point.lng, lat: r.point.lat};
