				...
				<el-aside width="239px">
					<el-menu :router="true" :collapse="isCollapse" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
					 background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
						...
						<el-menu-item index="/carManage" v-if="common.fetchData('company').carrierType === 1">
							<i class="ico-car"></i>
							<span slot="title">车辆管理</span>
						</el-menu-item>
						<el-menu-item index="/carWayManage" v-if="common.fetchData('company').carrierType === 2">
							<i class="ico-car"></i>
							<span slot="title">车辆管理</span>
						</el-menu-item>
...
.el-dropdown-link {
  ...
  .demonstration {
	...
	.ico-home,.ico-account,.ico-news,.ico-car,.ico-driver,.ico-line {
		width: 14px;
		height: 14px;
