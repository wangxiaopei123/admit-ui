                            ...
                            <div class="car-way-table" v-if="showWayRescueTable===1">
                                <el-table :data="rescuetableData"
                                    ...
                                    <el-table-column fixed="right" label="操作" width="260">
                                        <!--
                                        <template slot-scope="scope">
                                            <el-button type="text" size="small" @click="addCarRescue=true;carRescuePkId=scope.row.rescuePkId">编辑</el-button>
                                            <el-button type="text" size="small" @click="changeDriverFun(scope.row.rescuePkId,1)">更换司机</el-button>
                                            <el-button type="text" size="small" @click="delConfir(scope.row.rescuePkId)">删除</el-button>
                                            <el-button type="text" size="small" @click="updateInsureInfoModel(scope.row.rescuePkId,'2','更新保险信息')">更新保险</el-button>
                                        </template>
                                        -->
                                    </el-table-column>
                                </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            openTransportDetailsInfo(row) { //道路运输许可证详情
                let that  = this;
                console.log("call transport detail...");
