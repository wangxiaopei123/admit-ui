                ...
                <div class="info-item info-other clear">
                    ...
                    <el-form-item label="通信地址：" class="address">
                        ...
                        <el-input v-model="ruleForm.companyAddress" class="width-other">
                            <template slot="append" ><span @click="openMap('companyAddress')"><i class="el-icon-location-outline"></i></span></template>
                        </el-input>
                    </el-form-item>
                ...
                <div class="info-item info-other clear">
                    ...
                    <el-form-item label="办公室地址：" class="address" style="height: 101px;">
                        ...
                        <el-input v-model="ruleForm.address">
                            <template slot="append"><span @click="openMap('address')"><i class="el-icon-location-outline"></i></span></template>
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="运作场地地址：" class="address">
                        ...
                        <el-input v-model="ruleForm.fieldAddress">
                            <template slot="append"><span @click="openMap('fieldAddress')"><i
        ...
        methods: {
            getCompanyOffice() {
                ...
                this.$get("transport/getCompanyOffice", data).then(function (response) {
                    ...
                    console.info(response.resultData.ltdCompanyOfficeVO)
                    // that.initCity()
                    ...
                    console.info(response.resultData.imgList)
            ...
            initCity: function (value, cityKey, clearKeys) {
                ...
                console.info(value + "--" + cityKey + "--" + clearKeys)
